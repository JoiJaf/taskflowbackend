...
class EventSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Event::create(['id'=> 5,'title'=>'Respuesta diseño de página web','description'=>'Va de nuevo Joiner','status'=>'Activo','image'=>'/img/default-image.png','tag_id'=> 3,'course_id'=> 3,'user_specific_id'=> 1, 'finish_date' => '2024-06-07']);
        ...
        Event::create(['id'=> 10,'title'=>'Elaborar una escaleta para el proyecto final','description'=>'Realizar la escaleta como se ha enseñado en clases para el cortometraje','status'=>'Activo','image'=>'/img/default-image.png','tag_id'=> 2,'course_id'=> 4,'user_specific_id'=> 1, 'finish_date' => '2024-06-07']);
        Event::create(['id'=> 11,'title'=>'Book Homework','description'=>'Complete pages 45 to 48 from the English book','status'=>'Activo','image'=>'/img/default-image.png','tag_id'=> 2,'course_id'=> 5,'user_specific_id'=> 1, 'finish_date' => '2024-06-07']);
        Event::create(['id'=> 12,'title'=>'Groot layout','description'=>'Realizar el trabajo tomando en cuenta el zip de mediación','status'=>'Activo','image'=>'/img/default-image.png','tag_id'=> 2,'course_id'=> 6,'user_specific_id'=> 1, 'finish_date' => '2024-06-07']);
        ...
        Event::create(['id'=> 14,'title'=>'Crear una BD en Mongo DB','description'=>'Realizar una base de datos tomando en cuenta los pasos vistos en clases','status'=>'Activo','image'=>'/img/default-image.png','tag_id'=> 2,'course_id'=> 7,'user_specific_id'=> 1, 'finish_date' => '2024-06-07']);
        ...
        Event::create(['id'=> 16,'title'=>'Realizar un paisaje','description'=>'Realizar un paisaje tomando en cuenta el punto de fuga','status'=>'Activo','image'=>'/img/default-image.png','tag_id'=> 2,'course_id'=> 8,'user_specific_id'=> 1, 'finish_date' => '2024-06-07']);
        ...
        Event::create(['id'=> 18,'title'=>'Realizar un diseño a color','description'=>'Realizar un diseño tomando en cuenta la psicología del color','status'=>'Activo','image'=>'/img/default-image.png','tag_id'=> 2,'course_id'=> 9,'user_specific_id'=> 1, 'finish_date' => '2024-06-07']);
        Event::create(['id'=> 19,'title'=>'Instalar Dr.Java','description'=>'Instalar el Dr.Java siguiendo los pasos del video subido en mediación','status'=>'Activo','image'=>'/img/default-image.png','tag_id'=> 3,'course_id'=> 10,'user_specific_id'=> 1, 'finish_date' => '2024-06-07']);
