...
class EventSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Event::create(['id'=> 8,'title'=>'Realizar premisa y sipnosis del proyecto','description'=>'Traer para la próxima clase la premisa y la sipnosis terminada','status'=>'Activo','image'=>'/img/default-image.png','tag_id'=> 2,'course_id'=> 4,'user_specific_id'=> 1, 'finish_date' => '2024-06-07']);
